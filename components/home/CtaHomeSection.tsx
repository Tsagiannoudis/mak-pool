                ...
                <div className="relative overflow-hidden rounded-3xl bg-[#0762BD] px-8 py-12 md:px-16 md:py-20 shadow-2xl">
                    ...
                    <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-10">
                        ...
                        <div className="flex-shrink-0 w-full lg:w-auto text-center">
                            <Link 
                                href="/contact" 
                                className="inline-block bg-white text-[#56B1E9] hover:bg-zinc-100 px-10 py-5 rounded-full font-bold text-lg transition-all shadow-lg hover:scale-105 active:scale-95"
                            >
                                Επικοινωνήστε τώρα
                            </Link>
                        </div>
